...
object MockData {
    val bins = listOf(
        BinData("BIN-042", "Darmo Kali", "Bandung", 96, BinStatus.CRITICAL,
            "2 menit yang lalu", 60, 48, -6.9100, 107.6050, "Segera dikosongkan"),
        BinData("BIN-089", "Gubeng",     "Bandung", 78, BinStatus.NEED_PICKUP,
            "5 menit yang lalu", 75, 42, -6.9050, 107.6200),
        BinData("BIN-055", "Rungkut",   "Bandung",  0, BinStatus.NORMAL,
            "1 jam yang lalu",   90, 35, -6.9300, 107.6100),
        BinData("BIN-103", "Cibuntu",   "Bandung", 45, BinStatus.NORMAL,
            "30 menit yang lalu", 85, 36, -6.9200, 107.5900),
        BinData("BIN-128", "Sukajadi",  "Bandung", 20, BinStatus.NORMAL,
            "45 menit yang lalu", 70, 34, -6.8950, 107.5950),
        BinData("BIN-145", "Pasteur",   "Bandung", 10, BinStatus.NORMAL,
            "1 jam yang lalu",   95, 33, -6.8900, 107.6000)
    )
    ...
    val routes = listOf(
        ...
        PickupRoute("TRK-03", "Zona C", 6, "07.45", TaskStatus.DONE, 6,
            bins),
    ...
    val notifications = listOf(
        ...
        NotificationItem("N-003", "BIN-042", "Suhu Tinggi",    "Suhu 48°C melebihi batas normal",      "8 mnt lalu",  BinStatus.CRITICAL),
        ...
        NotificationItem("N-006", "BIN-056", "Sensor Error",   "Baterai lemah 12%",                    "30 mnt lalu", BinStatus.NEED_PICKUP),
